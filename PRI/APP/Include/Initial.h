...
#define OUTPUT_VOLT_SCALE               (4725.0f)   //New add 400V BBU 4725 //400V BBU 7439
#define DEFAULT_OUTPUT_VOLT_RATIO       (8466.0f)   //New add 400/472.478 = 0.8466 //400/743.985 = 0.537645
...
#define CHARGE_VOLT_SCALE               (3739.0f)   //304V BBU 3739
#define DEFAULT_CHARGE_VOLT_RATIO       (8130.0f)   //304/373.924 = 0.8130
#define DEFAULT_CHARGE_VOLT             (long)(CHARGE_VOLT_SCALE * DEFAULT_CHARGE_VOLT_RATIO / 1e4f)

#define CHARGE_CURR_SCALE               (2188.0f)  //21.88A
#define DEFAULT_CHARGE_CURR_RATIO1      (274.0f)   //0.6/21.88=0.0274
